      ...
      <AnimatePresence mode="wait">
        {step === 0 && (
          <motion.h2
            ...
            exit={{ opacity: 0 }}
          >
            Congratulations chootty! You have completed the game.
          </motion.h2>
        )}
        {step === 1 && (
          <motion.h2
        ...
        {step === 2 && (
          ...
          >
            ...
            <h2
              className={`text-5xl font-semibold mb-8 ${playfairDisplay.className} text-center`}
            >
              Would you like to join me for a<br />
              movie date on Sunday?
            </h2>
            <Image
              src="/baby-love.jpeg"
              alt="Sad baby"
